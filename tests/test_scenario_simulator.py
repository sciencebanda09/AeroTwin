...
def test_no_adjustment_yields_zero_delta() -> None:
    comparison = simulate_scenario(_baseline(), ScenarioAdjustment())
...
def test_lower_compressor_efficiency_reduces_health() -> None:
    ...
    comparison = simulate_scenario(_baseline(), adjustment)
...
def test_missing_required_field_raises() -> None:
    ...
    with pytest.raises(KeyError):
        simulate_scenario(incomplete, ScenarioAdjustment())
